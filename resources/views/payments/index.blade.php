        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <h3>Student details
                            <a href="{{ route('generateInvoice')}}" onclick="window.print()" class="btn btn-secondary float-right">Download invoice</a> 
                        </h3>
                        </div>
                            <?php       
                                (int)$totalPaidFee = 0;
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                            <h3>Payments records
                                <a href="{{ route('createPayments') }}" class="btn btn-success float-right">Make payment</a> 
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="card">
